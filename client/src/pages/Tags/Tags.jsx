...
const Tags = () => {
    ...
    },
    {
        id:5,
        tagName:"php",
        tagDesc:"PHP is an open-source, multi-paradigm, dynamically-typed, and interpreted scripting language designed initially for server-side web.."
    },
    {
        id:6,
        tagName:"android",
    ...
    },
    {
        id:8,
        tagName:"jquery",
        tagDesc:"jQuery is a JavaScript library. jQuery is a popular cross-browser JavaScript library that facilitates Document Object Model (DOM) traversal, event handling.."
    },
    {
        id:9,
        tagName:"c++",
        tagDesc:"C++ is a general-purpose programming language. Use this tag for questions about/utilizing C++. Do not also tag questions with [c] unless.."
    },
    {
        id:10,
        tagName:"css",
  ...
  return (
    <div className='home-container-1'>
        ...
        <div className='home-container-2'>
            ...
            <p className='tags-p'>A tags is a keyword or label that categories your question with other, similar question</p>
            <p className='tags-h'>Using the right tags makes it easier for others to find and answer your question</p>
